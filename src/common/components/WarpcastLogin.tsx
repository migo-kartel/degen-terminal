    ...
    return (
      <div className="my-8 divide-y divide-gray-500">
        {pendingAccounts.map((account) => {
          ...
          return (
            <div className="py-8" key={account.id}>
              ...
              {signerToken && (
                <>
                  ...
                  <QrCode
                    deepLink={`https://client.warpcast.com/deeplinks/signed-key-request?token=${signerToken}`}
                  />
                </>
              )}
            </div>
  ...
  return (
    <div>
      <div className="max-w-md">
        <label
          htmlFor="accountName"
          className="block text-lg font-medium leading-6 text-foreground/80"
        >
          Display name
        </label>
